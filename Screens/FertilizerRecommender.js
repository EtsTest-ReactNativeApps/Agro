...
const FertilizerRecommmender = props => {
    ...
    return <SafeAreaView style={{flex:1}}>        
            <ScrollView showsVerticalScrollIndicator={false} style={{width:width,height:height}} contentContainerStyle={{backgroundColor:'#F8F8F8',alignItems:'center',flexGrow:1,padding:12,justifyContent:'flex-start'}}>
