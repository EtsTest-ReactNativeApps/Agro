...
const CropNewCompo = props => {
    ...
    return <View style={{
        ...
        <View style={{width:'100%',height:height*0.15*0.5,flexDirection:'row'}}>
            <View style={{width:height*0.25*0.4,height:height*0.25*0.4}}>
                <Image source={cropData[props.name.toLowerCase()].image} style={{width:'100%',height:'100%',resizeMode:'cover'}} />
            </View>
            <View style={{marginLeft:20,width:width*0.95*0.45,height:height*0.08,flexDirection:'column',justifyContent:'flex-start'}}>
                <View>
                    <Text style={{fontFamily:'Sora-SemiBold',fontSize:16,color:'#313131'}}>{props.name}</Text>
                </View>
                <View>
                    <Text style={{fontFamily:'Sora-Regular',fontSize:13,marginTop:height*0.015,color:'#9F9F9F'}}>
                        starts from  <Text style={{fontFamily:'Sora-SemiBold',marginLeft:5,fontSize:15,marginTop:height*0.015,color:'#313131'}}>
                           {cropData[props.name.toLowerCase()].price}
                        </Text>
        ...
        <View style={{width:width*.9,marginTop:height*0.01*0.05,alignItems:'center',flexDirection:'row',justifyContent:'flex-end'}}>
           ...
           <View style={{width:height*0.15*0.4,height:height*0.15*0.4,alignItems:'center',justifyContent:'center'}}>
                <Pressable onPress={()=>Linking.openURL(cropData[props.name.toLowerCase()].URL)} style={{width:height*0.18*0.25,height:height*0.18*0.25}}>
        ...
        {/* {visible?<View style={{width:'100%'}}>
            ...
            <View style={{width:width*0.9,height:1.2,marginVertical:15,backgroundColor:'#DBD7D7'}} />
...
export default React.memo(CropNewCompo);